...
class Binomial(Distribution):
    ...
    def calculate_stdev(self):
        ...
        st_dev = float(math.sqrt(self.n*self.p*(1-self.p)))
        self.stdev = st_dev
        return self.stdev
    ...
    def replace_stats_with_data(self):
        ...
        """        
        Distribution.read_data_file(self,'numbers_binomial.txt')
    ...
    def pdf(self, k):
        ...
        return float((math.factorial(self.n)/(math.factorial(k)*math.factorial(self.n-k)))*(self.p ** k)*((1-self.p) ** (self.n-k)))
